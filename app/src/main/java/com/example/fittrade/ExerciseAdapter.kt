...
class ExerciseAdapter (val context: Context, val list: ArrayList<ExerciseDataResponse.ExerciseDataResponseItem>)
    : RecyclerView.Adapter<ExerciseAdapter.ViewHolder>(){
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val excerciseName : TextView = itemView.findViewById(R.id.tvrecycle_excercise_name)
        val exerciseTime : TextView = itemView.findViewById(R.id.tvrecycle_time)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.exerciseTime.text =  list[position].Force
